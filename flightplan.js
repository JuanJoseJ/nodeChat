...
plan.remote(function (remote) {
  ...
  remote.sudo(
    "docker stop node_chat_container && docker rm node_chat_container && docker run --name node_chat_container --restart=always -d -p 80:3000 chatbox:" +
      version,
    { user: username }
  );
